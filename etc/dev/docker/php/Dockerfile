...
RUN echo http://mirror1.hs-esslingen.de/pub/Mirrors/alpine/v3.11/main > /etc/apk/repositories; \
    echo http://mirror1.hs-esslingen.de/pub/Mirrors/alpine/v3.11/community >> /etc/apk/repositories
