...
Feature: In order to manage files remotely
  ...
  Scenario: I can get a list of files and directories of one directory
    ...
    When I get the file pool contents of "/apitester@shinage.test/"
  ...
  Scenario: I cannot get a list of files and directories of another user's directory
    Given I use the api key "testapikey"
    When I get the file pool contents of "/othertester@shinage.test/"
  ...
  Scenario: I cannot get a list of files and directories from a non existing user
    Given I use the api key "testapikey"
    When I get the file pool contents of "/you-dont-get-me@nowhere.test/"
    Then I should get an Access Denied response

  Scenario: I can upload a file
    Given I use the api key "testapikey"
    When I put a file to "/apitester@shinage.test/folder/file.txt" with contents:
      """
      Content of the file.
      """
  ...
  Scenario: I can upload and see a file
    ...
    When I put a file to "/apitester@shinage.test/folder/file.txt" with contents:
      ...
      Content of the file.
      """
    And I get the file pool contents of "/apitester@shinage.test/folder/"
  ...
  Scenario: I can upload a file and retrieve its contents later
    ...
    When I put a file to "/apitester@shinage.test/folder/file.txt" with contents:
      ...
      Content of the file.
      """
    And I get the file pool contents of "/apitester@shinage.test/folder/file.txt"
  ...
  Scenario: I can upload a file and overwrite it and retrieve its contents later
    ...
    When I put a file to "/apitester@shinage.test/folder/file.txt" with contents:
      ...
      Content of the file.
      """
    And I put a file to "/apitester@shinage.test/folder/file.txt" with contents:
      """
  ...
  Scenario: I cannot upload a file named as a directory
    Given I use the api key "testapikey"
    When I put a file to "/apitester@shinage.test/folder/" with contents:
      """
      Content of the file.
      """
  ...
  Scenario: I cannot upload a file named like an existing directory
    ...
    When I put a file to "/apitester@shinage.test/folder/file.txt" with contents:
      ...
      Content of the file.
      """
    And I put a file to "/apitester@shinage.test/folder" with contents:
      """
      Content of the file.
      """
    Then I should get a Bad Request response
  ...
  Scenario: I can delete a file
    Given I use the api key "testapikey"
    When I delete at "/apitester@shinage.test/dir1/file1"
    And I get the file pool contents of "/apitester@shinage.test/dir1/"
    Then I can see that the api response does not contain file "file.txt"

  Scenario: I cannot delete a non existing file
    Given I use the api key "testapikey"
    When I delete at "/apitester@shinage.test/dir5/file8"
    Then I should get a Not Found response
  ...
  Scenario: I can delete an empty directory
    ...
    When I delete at "/apitester@shinage.test/dir1/file1"
    Then I should get a No Content response
    When I delete at "/apitester@shinage.test/dir1"
    Then I should get a No Content response
  ...
  Scenario: I cannot delete a file above my root
    Given I use the api key "testapikey"
    When I delete at "/apitester@shinage.test/dir5/..%2F..%2F..%2F..%2Fetc/passwd"
    Then I should get an Access Denied response
  ...
  Scenario: I can get a 304 for a cached files
    ...
    When I get the file pool contents of "/apitester@shinage.test/dir1/cached1" if modfied since "2018-06-01 00:00:00"
  ...
  Scenario: I can get a 200 for a cached but modified files
    ...
    When I get the file pool contents of "/apitester@shinage.test/dir1/cached1" if modfied since "2018-01-01 00:00:00"
    Then I can see that the api request was successful
