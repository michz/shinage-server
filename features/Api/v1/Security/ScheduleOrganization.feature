...
Feature: In order to manage the schedule in an organization
  ...
  Background:
    ...
    And The organization "band" has the right to "schedule.get" for the screen "sheet"
    And The organization "band" has the right to "schedule.put" for the screen "sheet"
    And The organization "band" has the right to "schedule.delete" for the screen "sheet"
